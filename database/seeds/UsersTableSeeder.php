...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('users')->insert([ 'dni' => '87654321L', 'name' => 'Carlos', 'surnames' => 'Torralba', 'adress' => 'Alicante', 'phone' => '668974523', 'typeUser' => 'Cliente', 'email' => 'carlos@gmail.com', 'password' => Hash::make('hola1234') ]);
        DB::table('users')->insert([ 'dni' => '48856872T', 'name' => 'Jose Enrique', 'surnames' => 'Rico Valera', 'adress' => 'Barcelona', 'phone' => '987654567', 'typeUser' => 'Cliente', 'email' => 'jose@gmail.com', 'password' => Hash::make('hola1234')]);
